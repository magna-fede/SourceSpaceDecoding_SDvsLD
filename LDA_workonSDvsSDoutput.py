...
with open("//cbsu/data/Imaging/hauk/users/fm02/first_output/LDA/whichSD/1123_SDvsSD_scores.P", 'rb') as f:
     SDSD_scores = pickle.load(f)

with open("//cbsu/data/Imaging/hauk/users/fm02/first_output/LDA/whichSD/1123_SDvsSD_coefficients.P", 'rb') as f:
...
SDSD_scores = pd.Series(SDSD_scores)
SDSD_coefficients = pd.Series(SDSD_coefficients)
...
sns.heatmap(avg_all.T, cmap="YlGnBu", xticklabels=False,vmax= 8.29760391425217e-10)
