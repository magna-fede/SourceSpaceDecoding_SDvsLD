...
scores['fruit'] = dict.fromkeys(kkROI)
scores['milk'] = dict.fromkeys(kkROI)
scores['odour'] = dict.fromkeys(kkROI)
...
def individual_confusion_matrix(sub):
    ...
    with open(f"/imaging/hauk/users/fm02/final_dTtT/individual_ROIs/SemCat/abs_balanced_scores_{sub}_nonconcatenated.P",
                  'wb') as outfile:
