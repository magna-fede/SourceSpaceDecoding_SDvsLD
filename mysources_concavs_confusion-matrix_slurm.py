...
def individual_confusion_matrix(sub):
    ...
    with open(f"/imaging/hauk/users/fm02/final_dTtT/individual_ROIs/SemCat/concabs_scores_{sub}.P",
                  'wb') as outfile:
            pickle.dump(scores,outfile)            
    with open(f"/imaging/hauk/users/fm02/final_dTtT/individual_ROIs/SemCat/concabs_confusion_matrix_{sub}.P",
              'wb') as outfile:
