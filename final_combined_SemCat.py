...
with open("//cbsu/data/Imaging/hauk/users/fm02/final_dTtT/combined_ROIs/SemCat/patterns.P",
          'wb') as outfile:
    pickle.dump(df_to_export,outfile)
    
# save the scores ...
df_to_export = pd.DataFrame(scores)
with open("//cbsu/data/Imaging/hauk/users/fm02/final_dTtT/combined_ROIs/SemCat/scores.P",
          'wb') as outfile:
    pickle.dump(df_to_export,outfile)
